...
// Strob600.ino
//
// Прием сигналов ИК-пульта и показ в мониторе порта с простым стробированием в 600 мкс

// В мониторе видно, что "0" и "1" идут, какой-то код получается, но видно что 
// при нажатии на одну и ту же клавишу, сигналы не всегда практически совпадают
